...
class Ui_NewGameWindowDialog_1(object):
    ...
    def retranslateUi(self, NewGameWindowDialog_1):
        ...
        NewGameWindowDialog_1.setWindowTitle(_translate("NewGameWindowDialog_1", "New Game"))
        self.label.setText(_translate("NewGameWindowDialog_1", "<html><head/><body><p align=\"center\">This is Guess The Word game. </p><p align=\"center\">The computer will generate a word and </p><p align=\"center\">you will have to guess the word </p><p align=\"center\">letter by letter or whole word at the moment.</p><p align=\"center\">But the first you should define number </p><p align=\"center\">of allowed tries and press \'Ok\' for startting the game</p></body></html>"))
